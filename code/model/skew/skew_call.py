...
from basic_function.calc_Greek import calc_call_delta
from basic_function.calc_implied_volatility import call_implied_vol

def skew_call(option_string='510050.SH', start_date=20190701, end_date=20210330):
    R = 0.02
    # k_all = []
    # s0_all = []
...
if __name__ == '__main__':
    x = skew_call('510050.SH', 20190701, 20210330)
    iv_diff_up_middle_low_pd = pd.DataFrame(x)
    iv_diff_up_middle_low_pd.to_csv(r"D:\pc\Desktop\Algo_Trading\Assignment2\result\data\mid\csv\call_iv_diff_up_mid_low.csv")