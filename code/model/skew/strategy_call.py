...
def skew_arbitrage_call(start_date = 20190701,end_date = 20210330):
    R = 0.02
    option_string = '510050.SH'
    data_path = r"D:\pc\Desktop\Algo_Trading\Assignment2\result\data\call_iv_diff_up_mid_low.csv"
    ...
    open_close_df.to_csv(r'D:\pc\Desktop\Algo_Trading\Assignment2\result\data\open_close_detail(call).csv')
    open_close_total_df.to_csv(r'D:\pc\Desktop\Algo_Trading\Assignment2\result\data\open_close_total(call).csv')

    return trade_date_all, balance_all


if __name__=='__main__':
    skew_arbitrage_call(20190701,20210330)
